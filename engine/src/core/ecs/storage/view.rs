...
//! to the [`Set`](crate::core::ecs::component::Set) trait used for writing components.
//!
//! # Overview
//!
...
//!
//! ```rust,ignore
//! use rusty_engine::core::ecs::storage::{Table, view::View};
...
//! # Design
//!
//! The [`View`] trait mirrors the [`Set`](crate::core::ecs::component::Set) trait's design:
...
///
/// ```rust,ignore
/// use rusty_engine::core::ecs::storage::view::View;
///
...
mod tests {
    ...
    use crate::core::ecs::{component, entity, storage::Table};
